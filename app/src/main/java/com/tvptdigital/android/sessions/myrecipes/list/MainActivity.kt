...
import com.tvptdigital.android.sessions.myrecipes.list.model.RecipeDifficulty.EASY
import com.tvptdigital.android.sessions.myrecipes.list.model.RecipeDifficulty.EXPERT
import com.tvptdigital.android.sessions.myrecipes.list.model.RecipeDifficulty.HARD
import com.tvptdigital.android.sessions.myrecipes.list.model.RecipeDifficulty.NORMAL
    ...
    FirebaseDynamicLinks.getInstance()
        ...
        .addOnSuccessListener(this) { pendingDynamicLinkData ->
          ...
          if (pendingDynamicLinkData != null) {
            ...
            if ("vegan".equals(option.toLowerCase())) {
